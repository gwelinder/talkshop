    ...
    <>
      <div className="w-full h-full flex flex-col">
        ...
        <div className="text-center mb-8">
          ...
          >
            <h1 className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 dark:from-gray-100 dark:to-gray-300 bg-clip-text text-transparent mb-4">
                ...
                >
                  <div className={`bg-white/10 dark:bg-gray-800/10 backdrop-blur-xl rounded-2xl overflow-hidden border transition-all duration-300 ${
                    ...
                    <div className="relative aspect-[3/4] overflow-hidden">
                      ...
                      {isCustomized && (
                        <div className="absolute top-4 left-4 w-6 h-6 bg-purple-500 rounded-full flex items-center justify-center shadow-lg">
                      ...
                      <motion.button
                        ...
                        className="absolute bottom-4 right-4 w-8 h-8 bg-white/90 dark:bg-gray-800/90 rounded-full flex items-center justify-center shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 hover:bg-white dark:hover:bg-gray-800"
