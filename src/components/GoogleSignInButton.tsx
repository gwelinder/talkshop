...
const GoogleSignInButton: React.FC<GoogleSignInButtonProps> = ({
  ...
  const variantClasses = {
    primary: 'bg-white hover:bg-gray-50 text-gray-900 border border-gray-300 shadow-lg hover:shadow-xl',
  ...
  return (
    <div className="flex flex-col items-center space-y-3">
      <motion.button
        ...
        className={`
          flex items-center justify-center space-x-3 rounded-xl font-semibold
